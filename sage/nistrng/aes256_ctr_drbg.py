...
# Python NIST RNG implementation adapted from https://github.com/GiacomoPope/kyber-py/blob/main/src/kyber_py/drbg/aes256_ctr_drbg.py
...
class AES256_CTR_DRBG:
    ...
    def __ctr_drbg_update(self, provided_data: bytes) -> None:
        ...
        """
        tmp = b""
        cipher = pyaes.AESModeOfOperationECB(self.key)
